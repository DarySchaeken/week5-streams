...
public class Challenge1 {
	public static void main(String[] args) {
		...
		// print alle tombolanummers die starten met D (of d) gesorteerd, steeds
		// met de eerste letter in uppercase
		// Gewenste output: D42 D50 D53
		tombolaNummers.stream().filter(s -> s.toUpperCase().contains("D")).sorted()
